...
namespace CanyonWebworks\pdfInkLite\lib\tecnick\tcpdf;
...
use Exception;
use Countable;
use CanyonWebworks\pdfInkLite\lib\tecnick\tcpdf\includes\TCPDF_FONT_DATA;
use CanyonWebworks\pdfInkLite\lib\tecnick\tcpdf\includes\TCPDF_FONTS;
use CanyonWebworks\pdfInkLite\lib\tecnick\tcpdf\includes\TCPDF_COLORS;
use CanyonWebworks\pdfInkLite\lib\tecnick\tcpdf\includes\TCPDF_IMAGES;
...
class TCPDF {
	...
	public function Image($file, $x=null, $y=null, $w=0, $h=0, $type='', $link='', $align='', $resize=false, $dpi=300, $palign='', $ismask=false, $imgmask=false, $border=0, $fitbox=false, $hidden=false, $fitonpage=false, $alt=false, $altimgs=array()) {
		...
		if ($newimage) {
			...
			$info = false;
			if ((method_exists('CanyonWebworks\pdfInk\PDF\lib\tecnick\tcpdf\includes\TCPDF_IMAGES', $mtd)) AND (!($resize AND (function_exists($gdfunction) OR extension_loaded('imagick'))))) {
